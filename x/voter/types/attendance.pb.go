...
func (*Attendance) Descriptor() ([]byte, []int) {
	return fileDescriptor_0d88b67afe04aee5, []int{0}
}
...
func (m *Attendance) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *Attendance) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *Attendance) GetTime() string {
	if m != nil {
		return m.Time
	}
	return ""
...
func init() {
	proto.RegisterType((*Attendance)(nil), "username.voter.voter.Attendance")
}

func init() { proto.RegisterFile("voter/attendance.proto", fileDescriptor_0d88b67afe04aee5) }

var fileDescriptor_0d88b67afe04aee5 = []byte{
	// 191 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Attendance) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Time) > 0 {
		i -= len(m.Time)
		copy(dAtA[i:], m.Time)
		i = encodeVarintAttendance(dAtA, i, uint64(len(m.Time)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
		i = encodeVarintAttendance(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Creator) > 0 {
		...
		i = encodeVarintAttendance(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0xa
	}
...
func skipAttendance(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupAttendance
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupAttendance = fmt.Errorf("proto: unexpected end of group")
)
