...
const baseQueryGetInforRequest = { id: 0 };
export const QueryGetInforRequest = {
    ...
    decode(input, length) {
        ...
        const message = { ...baseQueryGetInforRequest };
...
const baseQueryGetInforResponse = {};
export const QueryGetInforResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetInforResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllInforRequest = {};
export const QueryAllInforRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllInforRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllInforResponse = {};
export const QueryAllInforResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllInforResponse };
        message.Infor = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export class QueryClientImpl {
    ...
    Infor(request) {
        ...
        return promise.then((data) => QueryGetInforResponse.decode(new Reader(data)));
    }
    InforAll(request) {
        const data = QueryAllInforRequest.encode(request).finish();
        const promise = this.rpc.request("example.blog.blog.Query", "InforAll", data);
        return promise.then((data) => QueryAllInforResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
