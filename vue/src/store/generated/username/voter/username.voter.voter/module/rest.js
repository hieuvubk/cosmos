...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryRequestAttendanceAll = (query, params = {}) => this.request({
         ...
         */
        this.queryAttendanceAll = (query, params = {}) => this.request({
         ...
         */
        this.queryAttendance = (id, params = {}) => this.request({
         ...
         */
        this.queryInformationAll = (query, params = {}) => this.request({
         ...
         */
        this.queryInformation = (id, query, params = {}) => this.request({
